...
from helpers.transform_data_task import transform_data
from helpers.fetch_aqi_data_task import fetch_data
from helpers.store_data_task import store_data
from helpers.fetch_last_two_days_task import fetch_last_two_days_data
from helpers.apply_arima_forecasting_task import apply_arima_forecasting
from helpers.store_arima_forecasting_task import store_arima_forecasting
...
apply_forecasting_task = PythonOperator(
    task_id="apply_forecasting_task",
